...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                 KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_CAPS,
                                            KC_LGUI, KC_SPC,  TO(2),            KC_ENT,    MO(1),  KC_LALT
    ),
    // Shift layer
    [1] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, S(KC_Z), S(KC_X), S(KC_C), S(KC_V), S(KC_B),                              S(KC_N), S(KC_M), S(KC_COMM), S(KC_DOT), S(KC_SLSH), KC_TRNS,
                                            KC_TRNS, KC_TRNS, TO(4),            KC_TRNS,   KC_TRNS, KC_TRNS
    ),
    [2] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_F11,  KC_F12,  KC_LBRC, KC_RBRC, KC_TRNS,                              KC_GRV,  KC_MINS, KC_EQL,  KC_TRNS, KC_TRNS, KC_TRNS,
                                            KC_TRNS, KC_TRNS, TG(2),            KC_TRNS,   MO(3),   KC_TRNS 
    ),
    ...
    [4] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                            KC_TRNS, KC_NO,   TG(4),            KC_TRNS,   KC_TRNS, KC_TRNS 
    )
    // [] = LAYOUT_split_3x6_3(
    //     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
    //     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
