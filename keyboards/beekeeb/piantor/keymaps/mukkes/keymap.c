...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                            KC_N,          KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LALT,
                                            KC_LGUI, LT(1, KC_SPC), LT(4, KC_ENT),     LT(2, KC_ENT), LT(1, KC_SPC), TO(0)
    ),
    // Shift layer
    [1] = LAYOUT_split_3x6_3(
        ...
        S(KC_LCTL), S(KC_Z), S(KC_X), S(KC_C), S(KC_V),    S(KC_B),                              S(KC_N), S(KC_M), S(KC_COMM), S(KC_DOT), S(KC_SLSH), KC_TRNS,
                                               S(KC_LGUI), KC_TRNS, KC_TRNS,          KC_TRNS,   KC_TRNS, KC_TRNS
    ),
    [2] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_F11,  KC_F12,  KC_LBRC, KC_RBRC, KC_TRNS,                              KC_GRV,        KC_MINS, KC_EQL,  KC_TRNS, KC_TRNS, KC_TRNS,
                                            KC_TRNS, LT(3, KC_SPC), KC_TRNS,      KC_TRNS, LT(3, KC_SPC), KC_TRNS 
    ),
    ...
    [4] = LAYOUT_split_3x6_3(
        KC_TRNS, KC_TRNS, KC_INS,  KC_HOME, KC_PGUP, KC_TRNS,                              KC_TRNS, KC_VOLD, KC_VOLU, KC_MUTE, KC_TRNS, KC_TRNS, 
        KC_CAPS, KC_TRNS, KC_DEL,  KC_END,  KC_PGDN, KC_TRNS,                              KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_PSCR, KC_SCRL, KC_PAUS, KC_NUM,                               KC_MPRV, KC_MPLY, KC_MSTP, KC_MNXT, KC_TRNS, KC_TRNS,
                                            KC_TRNS, KC_LSFT, KC_NO,            KC_TRNS,   KC_RSFT, KC_TRNS 
    )
    // [] = LAYOUT_split_3x6_3(
